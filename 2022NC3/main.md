...
Heldigvis findes der et script btcrecover https://github.com/gurnec/btcrecover som kan lave en dictionary password attack, på mange forskellige cryptocurrencies wallet formats, heriblandt Electrum. Password filen rockyou.txt plejer at være det første man forsøger med i en typisk CTF opgave
...
Efter at indtaste kodeordet i Electrum, får jeg endelig adgang til min bitcoin adresse dog med en saldo på 0 bitcoins. I stedet får jeg et flag som ses under fanen Receive.
...
Vi er givet et ELF (executable) binary, som tager en streng, og krypterer hver enkelt karakter til et tal mellem 0 og 65535. Denne krypterede karakter er et Dst port i en UDP PACKET, som bliver sendt til 127.0.0.1. Opgaven giver os en PCAPNG fil, som i princippet er cipher-tekst. I stedet for at reverse krypterings-algoritmen fra ELF-filen, kan man bare brute force ved at køre ELF-binary med karakter ad gangen, indtil det passer med PCAPNG filen. Dette kan kun gøres fordi det er en simpel stream cipher, hvor hver karakter er krypteret uafhængigt af hinanden. 
